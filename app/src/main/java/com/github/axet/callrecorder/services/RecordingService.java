...
public class RecordingService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    class PhoneStateChangeListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(final int s, final String incomingNumber) {
            Timber.e("onCallStateChanged: incomingPhoneNumber = " + incomingNumber);
...
//                MediaRecorder.AudioSource.VOICE_CALL,
    ...
    private void updateRecordDb(){
        Record record = new Record(targetUri.getPath(), phone, contact, contactId, call, now);
        recordDao = AppDatabase.getAppDatabase(getApplicationContext()).recordDao();
